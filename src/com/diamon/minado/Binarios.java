...
public class Binarios {
	...
	public long hexadecimalDecimal8(String texto) {
		...
		long numeroDecimal = (long) (numero[7] + numero[6] * (16) + numero[5] * Math.pow(16, 2)
	...
	public String obtenerObjetivo(String bitHex) {
		...
		long exponente = hexadecimalDecimal8(bitHex) >> 24;

		long numoroObtenido = hexadecimalDecimal8(bitHex) & 0xffffff;
	...
	public String decimalHexadecimal(long numero) {
		...
		String t = Long.toHexString(numero);
